...
import { signup , signin } from '../redux/reducerSlice/userSlice.js'
...
function Auth({setUser}) {
    ...
    // />
    return (
        <Container component="main"  style={{display: 'flex',maxWidth: "none",margin: 0, marginTop: "150px",}}>
            ...
            <Paper className={classes.paper} elevation={3}>
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <Grid container justify="center">
                        <Grid item>
                                { isSignup ?
                                    <Button onClick={switchMode} style={{padding : "0px", marginTop: "10px"}}>
                                        <Paper elevation={6} component="h3" className={classes.switchMode}>Sign In! </Paper>
                                    </Button>
                                    :
                                    <Button onClick={switchMode} style={{padding : "0px", marginTop: "10px"}}>
                                        <Paper elevation={6} component="h3" className={classes.switchMode}>Sign Up!</Paper>
                                    </Button>
                                }
                        </Grid>
                    </Grid>
