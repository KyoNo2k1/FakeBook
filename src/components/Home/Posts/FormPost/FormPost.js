...
import { Avatar, Button, Divider, Grid, Modal } from "@mui/material";
    ...
    <Grid className={classes.formPost} container xs={12} sm={12} lg={12}>
      <div>
        <Grid
          ...
          lg={12}
          alignItems="center"
          className={classes.formPostTop}
        >
          <Avatar
            alt="Nghia"
            src={userImg}
            className={classes.formPostAvatart}
          />
          <Button
            fullWidth
            className={classes.formPostMessage}
            onClick={handleOpenForm}
          >{`${userName} write here`}</Button>
        </Grid>
      </div>
      <Divider
      ...
      <div>
        <Grid
          className={classes.formPostBottom}
          container
          xs={12}
          sm={12}
          lg={12}
